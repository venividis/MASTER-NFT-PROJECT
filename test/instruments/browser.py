...
with sync_playwright() as p:
 ...
 check('Original and instruments boot together',E("__idfbi.version==='1.2.0'&&__instruments.version==='1.5.0'"))
 ...
 download=dl.value;download.save_as(O/'browser-export.json');exported=json.loads((O/'browser-export.json').read_text());check('Export is a tagged unsigned local archive',exported['engine']['schema']=='idfbi/instruments/1.5')
